//2018.10.10, Assignment 1, class Person that contains information of a person's name, gender, and telephone number with all the features of class Birthday
...
public class Person extends Birthday
{
	 ...
	 */
	private void setName( String name ) { this.name = name; } //end method setName
	 ...
	 */
	private void setTel( String tel ) { this.tel = tel; } //end method setTel
	
	/**
	 * Get the person's name.
	 * @return the person's name
	 */
	protected String getName() { return name; } //end method getName
	
	/**
	 * Get the person's gender.
	 * @return the person's gender
	 */
	protected String getGender() { return gender; } //end method getGender
	
	/**
	 * Get the person's telephone number.
	 * @return the person's telephone number
	 */
	protected String getTel() { return tel; } //end method getTel
} //end class Person