// class Student that contains a student's ID, name, age and scores with built-in generic interface Comparable used
...
public class Student implements Comparable<Student>
{
	...
	/**
	 * Help to sort Student objects in descending order by the total score of English, Maths, and Chinese.
	 */
	@Override
