//2018.10.17, class Student that contains a student's name and score with built-in generic interface Comparable used
...
public class Student implements Comparable<Student>
{
	...
	//override method compareTo to help to sort Student objects in ascending order by the value of "score"
	@Override
